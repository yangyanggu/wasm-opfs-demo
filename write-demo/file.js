...
// Begin JS library code
  ...
  instrumentWasmImports(imports) {
        var importPattern = /^(sleep_for_seconds|invoke_.*|__asyncjs__.*)$/;
...
var _sleep_for_seconds = Module['_sleep_for_seconds'] = createExportWrapper('sleep_for_seconds', 0);
var _write_to_file = Module['_write_to_file'] = createExportWrapper('write_to_file', 0);
